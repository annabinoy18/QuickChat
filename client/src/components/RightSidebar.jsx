...
const RightSidebar = () => {
  ...
  return selectedUser && (
    ...
    ${selectedUser?"max-md:hidden" : ""}`}>
      ...
      <button onClick={()=> logout()} className='absolute bottom-4 left-1/2 transform -translate-x-1/2
        bg-gradient-to-r from-purple-400 to-violet-600
        text-white border-none text-base font-light
        py-3 px-24 rounded-full cursor-pointer shadow-lg
